  ...
  <div class="container content-space-2 content-space-lg-3">
    ...
    <div class="row">
        ...
        <div class="pe-lg-6">
          ...
          <figure class="device-browser">
            ...
            <div class="device-browser-frame">
              <img class="device-browser-img" src="https://htmlstream.com/preview/front-v4.3.1/assets/img/1618x1010/img6.jpg" alt="Image Description">
            </div>
          </figure>
          <!-- End Browser Device -->
        </div>
      ...
      <div class="col-lg-5">
        ...
        <div class="row">
          <div class="col py-3">
            <img class="avatar avatar-4x3" src="https://htmlstream.com/preview/front-v4.3.1/assets/svg/brands/fitbit-dark.svg" alt="Logo">
          </div>
          <!-- End Col -->
