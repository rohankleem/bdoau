	...
	<div class="row mb-3">
		...
		<div class="col-sm-6 col-md-4 mb-3 mb-sm-6">
			<div class="d-flex align-items-center mb-2">
				...
				<div class="flex-grow-1 ms-3">
					<h4 class="mb-0">Streamline your work</h4>
				</div>
			</div>
			<p>Discover new opportunities to grow your business and improve processes.</p>
		</div>
		...
		<div class="col-sm-6 col-md-4 mb-3 mb-sm-6">
			<div class="d-flex align-items-center mb-2">
				...
				<div class="flex-grow-1 ms-3">
					<h4 class="mb-0">Generate more sales</h4>
				</div>
			</div>
		...
		<div class="col-sm-6 col-md-4 mb-3 mb-sm-6 mb-md-0">
			<div class="d-flex align-items-center mb-2">
				...
				<div class="flex-grow-1 ms-3">
					<h4 class="mb-0">Gain clearer insights</h4>
				</div>
			</div>
